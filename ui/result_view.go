...
func (ui *TestUI) createResultTab() fyne.CanvasObject {
	...
	// Registry provenance is intentionally absent from the user-facing status
	// bar. Data loading remains an internal implementation detail.
	statusBar := container.NewVBox(statusRow, ui.CurrentItem, ui.ProgressBar, ui.PartialReasonLabel)
